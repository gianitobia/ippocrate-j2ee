...
<html>
    ...
    <body>
        ...
        <form id="form_medico" action="" style="display:block;">
            <h1>Login medico</h1>
            ...
            <label for="pincode-medico">Pin code : </label><input name="pincode-medico"type="text" value=""/>
        </form>
        <form id="form_paziente" action="" style="display:none;">
            ...
            <label for="password-paziente">Password : </label><input name="password-paziente" type="password" value=""/>
        </form>
    </body>
</html>
