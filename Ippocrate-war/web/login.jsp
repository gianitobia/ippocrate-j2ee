...
<html>
    ...
    <body>
        ...
        <form id="form_medico" action="LoginServlet?action=loginM" style="display:block;" method="POST">
            <h1>Login medico</h1>
        ...
        <form id="form_paziente" action="LoginServlet?action=loginP" style="display:none;" method="POST">
