...
public class TestConnectToCalendar extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            PrenotazioneSala p = new PrenotazioneSala();
            p.setId(new Long(69));
            p.setGoogleId(null);

            String startDateString = "2014-03-26T10:00:00.000+01:00";
            SimpleDateFormat ft = new SimpleDateFormat("yyyy-MM-dd'T'kk:mm:ss.S'+01:00'");
            try {
                p.setData_prenotazione(ft.parse(startDateString));
